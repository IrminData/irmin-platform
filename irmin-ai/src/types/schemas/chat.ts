...
// MCP reinitialize response schema
export const McpReinitializeResponseSchema = z.object({
  success: z.boolean(),
  initialized: z.boolean(),
  toolCount: z.number(),
  message: z.string(),
...
export type McpReinitializeResponse = z.infer<typeof McpReinitializeResponseSchema>;
