...
export async function generateMetadata({
  ...
  return {
    title: `Workspace Settings | ${formattedWorkspace} | IRMIN Portal`,
  };
}

/**
 * Layout for the Workspace Settings pages in the Portal
 */
export default function PortalWorkspaceSettingsLayout({
  children,
}: Readonly<{
  params: WorkspaceLayoutParams;
