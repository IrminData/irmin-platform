...
/**
 * Console Workspace settings page
 *
 * @remarks
 *
 * This page is used to manage workspace settings in the console.
 ...
 * @remarks
 *
 * This component is used to manage workspace's general settings in the console.
