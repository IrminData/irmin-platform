...
const fi = {
  ...
  misc: {
    ...
    close: 'Sulje',
    timestamp: 'Aikaleima',
    areYouSureYouWantToDelete: 'Oletko varma, että haluat poistaa tämän?',
  ...
  connections: {
    ...
    create: {
      ...
      configuration_valid: 'Yhdeyden konfiguraatio on validi',
  ...
  workflow: {
    ...
    pipelineWorkflows: 'Dataputki prosessit',
    ...
    create: {
      ...
      createNewActionWorkflow: 'Luo uusi toiminto',
      createNewImportWorkflow: 'Luo uusi tuonti',
      createNewExportWorkflow: 'Luo uusi vienti',
      createNewPipelineWorkflow: 'Luo uusi dataputki',
    ...
    pipeline: {
      ...
      executablePathDescription:
        'Polku ajettavaan skriptiin esim. /path/to/script.py',
      connectionWritePath: 'Kirjoitettava polku',
      connectionWritePathDescription:
        'Yhteyden kirjoitettava polku esim. /path/to/write',
      connectionReadPath: 'Luku polku',
      connectionReadPathDescription:
        'Yhteyden luettava polku esim. /path/to/read',
      moveUp: 'Siirrä ylös',
      moveDown: 'Siirrä alas',
      removeStage: 'Poista vaihe',
  ...
  invite: {
    loginToAccept: 'Kirjaudu sisään hyväksyäksesi kutsun',
    ...
    acceptAndCreateAccount: 'Hyväksy ja luo tili',
    acceptInvitation: 'Hyväksy kutsu',
    workspaceInvitation: 'Kutsu työtilaan',
    workspaceInvitationDescription: 'Olet saanut kutsun liittyä työtilaan',
    invitedBy: 'Kutsuja',
    workspace: 'Työtila',
