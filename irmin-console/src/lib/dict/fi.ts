...
const fi = {
  ...
  consoleHome: {
    ...
    browseRepositories: 'Data ja tietovarastot',
  ...
  repository: {
    ...
    immutableWarningDescription:
      'Tämä tietovarasto tai valittu haara on muuttumaton, eikä sitä voi muokata.',
    branches: {
      branches: 'Haarat',
  ...
  workflow: {
    ...
    importDestinationRepository: 'Tuonnin kohdetietovarasto',
    ...
    exportSourceRepository: 'Vientilähteen tietovarasto',
    ...
    schedule: {
      ...
      repositoryEventTrigger: 'Tietovaraston tapahtumalaukaisin',
