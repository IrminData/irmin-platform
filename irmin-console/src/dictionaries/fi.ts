...
const fi = {
  ...
  workflow: {
    ...
    settings: {
      ...
      description: 'Kuvaus',
      owner: 'Omistaja',
      executable: 'Skriptitiedosto',
      sourceConnection: 'Lähde yhteys',
      pathImport: 'Tuontipolku',
      destinationConnection: 'Määränpää yhteys',
      pathExport: 'Vientipolku',
      recursive: 'Rekursiivinen',
      notRecursive: 'Ei rekursiivinen',
