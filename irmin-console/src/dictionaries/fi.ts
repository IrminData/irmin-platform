...
const fi = {
  ...
  repository: {
    ...
    compare: {
      failedToFetchDiff: 'Eroavaisuuksien hakeminen epäonnistui',
      failedToFetchDiffContent:
        'Eroavaisuuksien sisällön hakeminen epäonnistui',
      failedToMergeRefs: 'Haarojen yhdistäminen epäonnistui',
      ...
      mergedRefsSuccessfully: 'Haarat yhdistetty onnistuneesti',
    },
    delete: {
