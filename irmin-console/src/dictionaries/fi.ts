...
const fi = {
  ...
  fileNavigator: {
    search: 'Etsi',
    searchPlaceholder: 'Etsi tiedostoja ja kansioita',
    createNewFileOrFolder: 'Luo uusi tiedosto tai kansio',
  ...
  actionResults: {
    ...
    switchToPlainText: 'Vaihda pelkkään tekstiin',
    switchToMarkdownEditor: 'Vaihda Markdown-editoriin',
