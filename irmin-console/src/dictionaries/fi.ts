...
const fi = {
  ...
  list: {
    ...
    source: 'Lähde',
    destination: 'Kohde',
    noWorkflowsFound: 'Ei prosesseja tässä työtilassa',
    noActionWorkflowsFound: 'Ei toimintoprosesseja tässä työtilassa',
    noExportWorkflowsFound: 'Ei vientiprosesseja tässä työtilassa',
    noImportWorkflowsFound: 'Ei tuontiprosesseja tässä työtilassa',
    noConnectionsFound: 'Ei yhteyksiä tässä työtilassa',
    noRepositoriesFound: 'Ei tietovarastoja tässä työtilassa',
  },
  fileNavigator: {
