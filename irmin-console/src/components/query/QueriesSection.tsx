  ...
  return (
    <div className='flex h-full w-full flex-col bg-background'>
      <div className='flex h-full flex-col lg:flex-row lg:overflow-y-scroll'>
        <div className='order-3 flex min-h-80 w-full flex-col overflow-y-scroll border-t border-border lg:order-1 lg:w-80 lg:border-0 lg:border-r'>
          <div className='p-4'>
          ...
          {queries.map((query, idx) => (
            <div
              className={`flex cursor-pointer flex-row items-center justify-between gap-2 border-b border-border p-4 transition-all hover:bg-card ${selectedQuery?.id === query.id ? 'bg-card' : ''} `}
              key={`query-${idx}`}
        ...
        <div className='order-1 h-full lg:order-2 lg:flex-grow lg:overflow-y-scroll'>
          <CodeMirrorEditor
            language='sql'
        ...
        {selectedQuery && (
          <div className='relative order-2 flex w-full flex-col gap-2 border-t border-border p-4 lg:order-3 lg:w-80 lg:overflow-y-scroll lg:border-0 lg:border-l'>
            <Button
              size={'icon'}
              variant={'ghost'}
