...
/**
 * Workflow Repositories section component
 *
 ...
 */
const WorkflowRepositoriesSection = ({ workflow }: { workflow: Workflow }) => {
      ...
      <div className='px-2 md:px-4'>
        <div className='flex w-full flex-col gap-2 px-2'>
          <h2 className='font-display text-2xl font-bold text-opacity-80 sm:text-3xl lg:text-5xl'>
            {dict.workflow.tabs.repositories}
          </h2>
          <p>{workflow.name}</p>
        </div>
      </div>
...
export default WorkflowRepositoriesSection;
