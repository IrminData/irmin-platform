...
export default function WebsiteContentSection() {
  return (
    ...
    >
      ...
      <div className='mb-16 px-4 md:absolute md:-right-96 md:top-28 md:-mr-56 md:mb-0 md:transform lg:top-1/2 lg:-mr-20 lg:-translate-y-1/2 xl:-right-80 xl:-mr-0'>
        <div className='relative max-w-max'>
          <Image
            className='absolute left-1/2 top-1/2 z-20 -mt-1 w-10/12 -translate-x-1/2 -translate-y-1/2 transform p-7'
            src='/ui-assets/elements/dashboard.png'
          ...
          <Image
            ...
            src='/ui-assets/elements/macbook.png'
            alt='Macbook frame'
            width={945}
            height={525}
          />
          <Image
            className='absolute -top-24 right-0 w-28 text-blue-500 md:right-96 md:mr-52 md:mt-px md:w-auto lg:mr-16 xl:-mr-20'
          ...
          />
          <Image
            className='absolute left-0 top-1/2 w-28 -translate-y-1/2 transform text-yellow-400 md:w-auto'
