        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap mb-24 lg:mb-18 justify-between items-center">
            <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
              ...
              <h3 className="mb-4 text-4xl md:text-5xl text-rich_black font-bold tracking-tighter leading-tight">
            ...
            <div className="w-full lg:w-auto">
              <div className="flex flex-wrap justify-center items-center md:justify-start -mb-2">
                <Link
                  className="inline-block py-4 px-6 mb-2 md:mb-0 w-full md:w-auto md:mr-5 text-lg leading-6 text-green-50 font-light text-center bg-ash_gray-500 hover:bg-ash_gray-600 focus:ring-2 focus:ring-ash_gray-500 focus:ring-opacity-50 border border-transparent rounded-full shadow-sm"
                  href="#"
                >
                  Open Positions
                </Link>
                <Link
                  className="inline-block py-4 px-6 w-full md:w-auto text-lg leading-6 font-light text-center text-rich_black bg-white border border-rich_black hover:border-rich_black focus:ring-2 focus:ring-rich_black focus:ring-opacity-50 rounded-full shadow-sm"
                  href="#"
                >
                  About Us
                </Link>
              ...
              <div className="flex flex-wrap -mx-4">
                <div className="w-full md:w-1/2 px-4 mb-10">
                  <div className="max-w-xs mx-auto">
                    <h3 className="mb-4 text-2xl md:text-3xl font-bold leading-9 text-rich_black">
                      <div className="inline-flex mb-6 mr-4 items-center justify-center w-12 h-12 bg-ash_gray-500 rounded-full">
                        <svg
                    ...
                    <Link
                      className="text-lg md:text-xl text-rich_black hover:text-rich_black font-light"
                      href="mailto:#"
                    >
                      hello@irmin.co
                    </Link>
                ...
                <div className="w-full md:w-1/2 px-4">
                  <div className="max-w-xs mx-auto">
                    <h3 className="mb-9 text-2xl md:text-3xl font-bold leading-9 text-rich_black">
                      <div className="inline-flex mb-6 mr-4 items-center justify-center w-12 h-12 bg-ash_gray-500 rounded-full">
                        <svg
                          className="h-6 text-white"
                          width={24}
                    ...
                    <Link
                      className="inline-block mr-8 text-ash_gray-500 hover:text-ash_gray-600"
                      href="#"
                    >
                      <svg
                        width={10}
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="px-4 py-8 md:p-10 bg-green-50 rounded-xl">
                <form>
                  <div className="mb-6">
                    <label
                      className="block mb-2 text-rich_black font-light leading-6"
                      htmlFor=""
                    >
                      Email
                    </label>
                    <input
                      className="block w-full py-2 px-3 appearance-none border border-rich_black rounded-full shadow-md text-rich_black leading-6 focus:outline-none focus:ring-2 focus:ring-ash_gray-500 focus:ring-opacity-50"
                      type="email"
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      className="block h-32 md:h-52 w-full py-2 px-3 appearance-none border border-rich_black rounded-lg shadow-md text-rich_black leading-6 focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-ash_gray-500 focus:ring-opacity-50 placeholder-rich_black resize-none"
                      placeholder="Your message..."
                      defaultValue={""}
                    />
                  </div>
                  <button className="block w-full py-4 px-6 text-lg leading-6 text-green-50 font-light text-center bg-ash_gray-500 hover:bg-ash_gray-600 focus:ring-2 focus:ring-ash_gray-500 focus:ring-opacity-50 rounded-full shadow-sm">
                    Send
                  </button>
                </form>
              </div>
