...
top. Complementary to `connectors/guides/connector-architecture.md`
...
See `connectors/guides/oauth-connectors.md` for the
...
- `connectors/guides/connector-architecture.md` — same topics
  from the connector's own point of view
- `connectors/guides/how-to-create-connectors.md` — building a
  new connector
- `connectors/guides/oauth-connectors.md` — OAuth flow + vendor
  list + static-vs-DCR
