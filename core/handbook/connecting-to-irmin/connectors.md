...
2. **Build it yourself** — the platform repository includes
   [Connectors builder guides](../../../connectors/guides/README.md), including
   `how-to-create-connectors.md`, `connector-architecture.md`, and
   `oauth-connectors.md`.
