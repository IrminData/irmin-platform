...
export const agentConfig: AgentConfig = {
  ...
  contextRequirements: [
    ...
    // Documentation context (statically injected from llm-docs folder)
    {
      ...
      required: false,
      description:
        'Irmin documentation covering concepts, scripting runtime, and object schemas. Statically injected for fast context loading. Use the documentation search capability for deeper queries.',
    },
  ],
};
