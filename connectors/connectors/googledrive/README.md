...
# Then from the Core project root:
...
See [`core/handbook/connector-architecture.md`](../../../core/handbook/connector-architecture.md)
...
> 🔒 **Client Secret Security**: The secret is encrypted at rest using Core's AES-256-GCM keyring. It's never exposed in API responses. See `core/handbook/connector-architecture.md` for details.
