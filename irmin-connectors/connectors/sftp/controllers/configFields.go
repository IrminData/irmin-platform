...
// ConfigFields godoc
// @Summary Get SFTP connector configuration fields
// @Description Get dynamic configuration fields for the SFTP connector based on the configuration key (details or settings)
// @Tags sftp
...
// @Router /sftp/configuration/{key}/fields [post]
