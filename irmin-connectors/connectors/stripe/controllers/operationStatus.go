...
// @Summary Get Stripe operation status
// @Description Get the current status of a Stripe operation using the operation token
// @Tags stripe
...
// @Router /stripe/operation/status [post]
