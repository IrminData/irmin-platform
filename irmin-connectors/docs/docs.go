...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/irminconnectorclient.OperationStatus"
                        }
                    },
                    "400": {
                        "description": "Bad request - invalid operation token",
    ...
    "definitions": {
        ...
        "irminconnectorclient.OperationStatus": {
            "type": "object",
            "properties": {
                "details": {
                    "type": "object",
                ...
                "subscriptions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/irminconnectorclient.Subscription"
                    }
                }
            }
        },
        "irminconnectorclient.Subscription": {
            "type": "object",
            "properties": {
                "CreatedAt": {
                    "type": "string",
