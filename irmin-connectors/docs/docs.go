    ...
    "paths": {
        ...
        "/mysql/operation/patch": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Data patched successfully",
                        "schema": {
                            "$ref": "#/definitions/fiber.Map"
                        }
                    },
