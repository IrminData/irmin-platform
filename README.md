...
AI text and tool inference runs exclusively through OpenRouter. Direct OpenAI
credentials in `ai/` remain embeddings-only; there is no direct model-provider
fallback path.
